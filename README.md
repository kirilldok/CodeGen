# nnc-codegen — MLIR & LLVM Backend

> **Курс:** Введение в тензорные компиляторы  
> **Задание:** LLVM (Codegen)  
> **Дедлайн:** 06 апреля
...
├── README.md               # этот файл
├── include/
│   ├── ../include/../include/graph.h             # структура данных графа (из задания FE)
│   ├── ../include/../include/mlir_emitter.h      # генератор MLIR
│   └── ../include/../include/codegen.h           # фасад пайплайна, опции командной строки
├── src/
│   ├── graph.cpp
