...
// ============================================================
// ../include/../include/graph.h — Вычислительный граф нейронной сети
//
// Описывает узлы (операции) и рёбра (тензоры) графа,
// загружаемого из формата ONNX (задание FE).
// Используется как входное представление для кодогенератора.
// ============================================================
