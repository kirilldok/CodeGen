...
// ============================================================
// ../include/test_framework.h — Минималистичный тест-фреймворк
//
// Не требует внешних зависимостей (Google Test, Catch2 и т.п.)
// Предоставляет:
//   • CHECK(cond)              — булево условие
//   • CHECK_EQ(a, b)           — равенство (с выводом значений)
//   • CHECK_NE(a, b)           — неравенство
//   • CHECK_CONTAINS(str, sub) — подстрока в строке
//   • CHECK_NOT_CONTAINS(s, p) — подстрока НЕ присутствует
//   • CHECK_THROWS(expr)       — выражение бросает исключение
//   • CHECK_NO_THROW(expr)     — выражение НЕ бросает
//   • TEST(suite, name)        — объявление теста
